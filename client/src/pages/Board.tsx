...
return (
  <div className="min-h-screen">
    ...
    <div className="mx-auto max-w-7xl px-6 pb-10 mt-6">
      {/* Page header */}
      <header className="mb-6 flex items-center justify-between rounded-xl px-6 py-4 bg-(--brand-panel)/60 backdrop-blur-sm ring-1 ring-white/10">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="rounded-lg bg-(--brand-accent) px-3 py-1.5 text-sm font-medium text-black hover:bg-(--brand-accent-2) transition-colors"
      ...
      {/* Quick add form */}
      {showAdd && (
        <div className="rounded-xl bg-(--brand-panel)/70 ring-1 ring-(--brand-ring) shadow-sm p-4">
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="sm:col-span-1">
              ...
              <input
                ...
                className="w-full rounded-lg border border-white/10 bg-(--brand-panel) px-3 py-2 outline-none text-(--brand-text) placeholder-zinc-500 focus:border-(--brand-accent) focus:ring-4 focus:ring-(--brand-accent)/15"
                placeholder="Short summary"
              />
            </div>
            <div className="sm:col-span-1">
              <label className="mb-1 block text-sm text-(--brand-muted)">Description</label>
              <input
                value={newDesc}
          ...
          <div className="mt-3">
            <button
              ...
              className="rounded-lg bg-(--brand-accent) px-3 py-1.5 text-sm font-medium text-black hover:bg-(--brand-accent-2)"
            >
              Create
            </button>
          </div>
